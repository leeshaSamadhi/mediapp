...
// Seed data initialization — data is now seeded on the backend via seed_data.py
// This function is kept for backwards compatibility but no longer writes to localStorage
export const initializeSeedData = () => {
  // No-op: All data is now stored in and loaded from the backend database.
  // The backend seed_data.py script handles seeding sample data.
}
